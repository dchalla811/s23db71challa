...
router.get('/', function(req, res, next) {
  res.render('index', { title: 'Wallets App', user: req.user });
});

router.get('/register', function(req, res) {
  res.render('register', { title: 'Wallets App Registration' });
});
...
router.get('/login', function(req, res) {
  res.render('login', { title: 'Wallets App Login', user: req.user });
});
